 ...
 return (
  <>
   <div className='nlf' id='nlf' name='nlf'>
    ...
    <NLFOverview overview={project.sections[0].overview} images={NLFimages} />
    <NLFResearch research={project.sections[1].research} images={NLFimages} />
    <NLFSynthesis
     synthesis={project.sections[2].synthesis}
     images={NLFimages}
    />
    <NLFIdeation ideation={project.sections[3].ideation} images={NLFimages} />
    <NLFImplementation
