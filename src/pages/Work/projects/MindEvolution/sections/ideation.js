    ...
    return (
        <Element id="ideation" name="ideation">
            ...
            <div className="tab-section">
                ...
                <div className="tab-section__content">
                    <p className="tab-section__content--title">
                        The app has to meet their needs, or this will not work
                    </p>
                    <p className="tab-section__content--desc">
            ...
            <div className="tab-section">
                ...
                <div className="tab-section__content">
                    <p className="tab-section__content--title">Draw it out</p>
                    <p className="tab-section__content--desc">
            ...
            <div className="tab-section">
                ...
                <div className="tab-section__content">
                    <p className="tab-section__content--title">
                        Users struggled to complete tasks
                    </p>
                    <p className="tab-section__content--desc">
            ...
            <div className="tab-section__full column">
                <span className="tab-section__content--title center">
                    Before
                </span>
                <img
            ...
            <div className="tab-section">
                ...
                <div className="tab-section__content">
                    <p className="tab-section__content--title">
                        I overcame losing focus of the user
                    </p>
                    <p className="tab-section__content--desc">
